...
export default defineComponent({
  ...
  data() {
    return {
      ...
      //page animation
      currentPage: 1,
      pages: [1, 2, 3, 4, 5], // Example: Creating 5 pages
  ...
  <main>
      ...
      >
        ...
        >
          <img
            ...
            :class="[
              'img-back-box',
              !isLaglutand ? ' img-back-box-active' : '',
            ]"
          />
          <p>
            Parallella system
    ...
    <div v-if="isLaglutand" id="Laglutande">
      ...
      <div id="element-to-pdf" :style="{ display: whenPdf, width: '565px' }">
        <div style="display: flex; align-items: center; gap: 180px">
          <img
            src="/swemount_logo.png"
            alt=""
            style="display: block; width: 30%; margin: 0 0 0 30px"
          />

          <div class="footer-child">
            <div style="display: flex; align-items: center">
              <i class="fa-solid fa-phone yellow" style="font-size: 20px"></i>
              <div>
                <p class="bold-font" style="font-size: 12px">07xxxxxxxx</p>
                <p>
                  <a
                    class="bold-font"
                    href="mailto:info@swemount.se"
        ...
        <div class="total-calc" :style="{ display: 'block', width: '565px' }">
          <div class="second-head" style="margin-top: 10px">
            <h1 class="bold-font" style="font-size: 28px">
              {{ langIsSe ? "Totalt" : "Total" }}
            </h1>
            <hr />
          </div>
          <div style="display: block; width: 30%; margin: 0 0 0 30px">
            <b class="bold-font" style="">Antal paneler:</b>
            {{ totalFinalCalc.tAntal }} <br />

            <b class="bold-font" style="">Vikt:</b>
            {{ Math.floor(totalFinalCalc.tVikt * 100) / 100 }} kg
            <br />
            <b class="bold-font" style="">Pris:</b>
            {{ totalFinalCalc.tPris }} SEK <br />
          </div>
    ...
    <div>
      ...
      <div class="pages-container">
        <div v-for="page in currentPages" :key="page" class="page-content">
          <h1>Page {{ page }}</h1>
    ...
    <div v-if="!isLaglutand" id="Parallella">
      <div class="motion-div position-container">
        <div id="page1" class="position-body">
            ...
            <div class="Terrangtyp-wrapper">
              ...
              <div class="terrangtyp">
                ...
                >
                  ...
                  <div class="discreption">
                    Område täckt med vegetation eller byggnader eller med
                    enstaka hinder med största inbördes avstånd lika med 20
                    gånger hindrets höjd (till exempel byar, förorter,
                    skogsmark).
                  </div>
                </div>
              </div>
              <div class="terrangtyp">
                ...
                >
                  ...
                  <div class="discreption">
                    Område där minst 15 % av arean är bebyggd och där
                    byggnadernas medelhöjd är > 15 m.
                  </div>
                </div>
              </div>
            </div>
