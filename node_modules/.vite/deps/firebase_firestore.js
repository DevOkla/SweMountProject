...
var Rt = class {
  constructor(t2, e) {
    this.action = t2, this.transaction = e, this.aborted = false, this.v = new q2(), this.transaction.oncomplete = () => {
      this.v.resolve();
    }, this.transaction.onabort = () => {
      e.error ? this.v.reject(new Pt(t2, e.error)) : this.v.resolve();
    }, this.transaction.onerror = (e2) => {
      const n = xt(e2.target.error);
      this.v.reject(new Pt(t2, n));
    };
  }
  ...
  abort(t2) {
    t2 && this.v.reject(t2), this.aborted || (C2("SimpleDb", "Aborting transaction:", t2 ? t2.message : "Client-initiated abort"), this.aborted = true, this.transaction.abort());
  }
  V() {
...
function re(t2) {
  return "nullValue" in t2 ? 0 : "booleanValue" in t2 ? 1 : "integerValue" in t2 || "doubleValue" in t2 ? 2 : "timestampValue" in t2 ? 3 : "stringValue" in t2 ? 5 : "bytesValue" in t2 ? 6 : "referenceValue" in t2 ? 7 : "geoPointValue" in t2 ? 8 : "arrayValue" in t2 ? 9 : "mapValue" in t2 ? te(t2) ? 4 : pe(t2) ? 9007199254740991 : 10 : O2();
}
function oe(t2, e) {
  if (t2 === e)
    return true;
...
function Dn(t2, e, n) {
  const s = t2.field.isKeyField() ? ct.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return null !== s2 && null !== i ? ce(s2, i) : O2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function ri(t2, e) {
  const n = e.currentDocument ? function(t3) {
    ...
    if ("setToServerValue" in e3)
      M2("REQUEST_TIME" === e3.setToServerValue), n2 = new $n();
      ...
      "increment" in e3 ? n2 = new Kn(t3, e3.increment) : O2();
...
var Fi = ["indexId", "uid", "arrayValue", "directionalValue", "orderedDocumentKey", "documentKey"];
var $i = ["indexId", "uid", "orderedDocumentKey"];
...
var gr = class {
  ...
  he(t2, e) {
    if ("nullValue" in t2)
      ...
      "mapValue" in t2 ? pe(t2) ? this.fe(e, Number.MAX_SAFE_INTEGER) : (this.pe(t2.mapValue, e), this.me(e)) : "arrayValue" in t2 ? (this.Ie(t2.arrayValue, e), this.me(e)) : O2();
  }
  we(t2, e) {
...
var Ir = class {
  ...
  Pe(t2) {
    const e = 255 & t2;
    0 === e ? (this.$e(0), this.$e(255)) : 255 === e ? (this.$e(255), this.$e(0)) : this.$e(t2);
  }
  be() {
    this.Me(0), this.Me(1);
  }
...
function kr(t2, e) {
  ...
  }(t2, e) : Or(t2, e) : e instanceof Ve ? Or(e, t2) : function(t3, e2) {
...
var Lr = class {
  constructor(t2, e) {
    this.user = t2, this.databaseId = e, this.Xe = new $r(), this.tn = new ws((t3) => un(t3), (t3, e2) => cn(t3, e2)), this.uid = t2.uid || "";
  }
  addToCollectionParentIndex(t2, e) {
    if (!this.Xe.has(e)) {
  ...
  createRange(t2, e, n) {
    n = n.sort((t3, e2) => br(t3, e2)).filter((t3, e2, n2) => !e2 || 0 !== br(t3, n2[e2 - 1]));
    const s = [];
    s.push(t2);
    for (const i2 of n) {
      const n2 = br(i2, t2), r = br(i2, e);
      if (0 === n2)
        s[0] = t2.Ge();
      else if (n2 > 0 && r < 0)
  ...
  getMinOffset(t2, e) {
    return At.mapArray(this.en(e), (e2) => this.nn(t2, e2).next((t3) => t3 || O2())).next(Qr);
  }
};
function qr(t2) {
...
var Jr = class {
  ...
  addMutationBatch(t2, e, n, s) {
    ...
    return r.add({}).next((o) => {
      ...
      for (const t3 of s) {
        ...
        h = h.add(t3.key.path.popLast()), a.push(r.put(c)), a.push(i.put(e2, Pi));
      }
      return h.forEach((e2) => {
  ...
  getAllMutationBatchesAffectingDocumentKeys(t2, e) {
    ...
    const s = [];
    return e.forEach((e2) => {
      const i = bi(this.userId, e2.path), r = IDBKeyRange.lowerBound(i), o = Xr(t2).X({
        range: r
      }, (t3, s2, i2) => {
...
var uo = class {
  constructor(t2) {
    this.kn = t2, this.buffer = new Ye(oo), this.On = 0;
  }
  Mn() {
    return ++this.On;
  }
...
var co = class {
  constructor(t2, e, n) {
    this.garbageCollector = t2, this.asyncQueue = e, this.localStore = n, this.$n = null;
  }
  start() {
  ...
  Bn(t2) {
    C2("LruGarbageCollector", `Garbage collection scheduled in ${t2}ms`), this.$n = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", t2, async () => {
      this.$n = null;
      try {
...
var ao = class {
  ...
  nthSequenceNumber(t2, e) {
    ...
    const n = new uo(e);
    return this.Ln.forEachTarget(t2, (t3) => n.Fn(t3.sequenceNumber)).next(() => this.Ln.Un(t2, (t3) => n.Fn(t3))).next(() => n.maxValue);
  }
  removeTargets(t2, e, n) {
...
var ho = class {
  ...
  Qn(t2, e) {
    ...
    return n.X({
      ...
      0 === t3 ? (i !== Ot.at && e(new ct(Ai(s)), i), i = o, s = r) : i = Ot.at;
    }).next(() => {
  ...
  getDocumentsMatchingQuery(t2, e, n, s) {
    ...
    return yo(t2).W(IDBKeyRange.bound(r, o, true)).next((t3) => {
      ...
      for (const i2 of t3) {
        ...
        t4.isFoundDocument() && (Pn(e, t4) || s.has(t4.key)) && (n2 = n2.insert(t4.key, t4));
      }
      return n2;
    });
  }
...
var Oo = class {
  ...
  zs(t2, e) {
    ...
    const n = e.store("collectionParents"), s = new $r(), i = (t3) => {
      if (s.add(t3)) {
  ...
  Js(t2, e) {
    ...
    return n.W().next((t3) => {
      ...
      return t3.forEach((t4) => {
        ...
        return new Ao(s, c, o, u).recalculateAndSaveOverlaysForDocumentKeys(new zi(e, Ot.at), t4).next();
      });
    });
  }
};
...
var $o = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.referenceDelegate = new ho(this, s), this.oi = e + "main", this.Tt = new Xi(u), this.ui = new bt(this.oi, this.ti, new Oo(this.Tt)), this.Ns = new no(this.referenceDelegate, this.Tt), this.remoteDocumentCache = wo(this.Tt), this.Os = new fr(), this.window && this.window.localStorage ? this.ci = this.window.localStorage : (this.ci = null, false === a && x2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  start() {
    return this.ai().then(() => {
  ...
  async shutdown() {
    this.xs = false, this.bi(), this.si && (this.si.cancel(), this.si = null), this.vi(), this.Pi(), await this.ui.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (t2) => {
      const e = new zi(t2, Ot.at);
  ...
  runTransaction(t2, e, n) {
    ...
    const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.ti) ? ji : 14 === r ? Qi : 13 === r ? Gi : 12 === r ? Ki : 11 === r ? Ui : void O2();
    var r;
    let o;
    return this.ui.runTransaction(t2, s, i, (s2) => (o = new zi(s2, this.Cs ? this.Cs.next() : Ot.at), "readwrite-primary" === e ? this._i(o).next((t3) => !!t3 || this.wi(o)).next((e2) => {
      if (!e2)
  ...
  li() {
    ...
    "function" == typeof (null === (t2 = this.window) || void 0 === t2 ? void 0 : t2.addEventListener) && (this.ei = () => {
      this.bi(), isSafari() && navigator.appVersion.match(/Version\/1[45]/) && this.Ys.enterRestrictedMode(true), this.Ys.enqueueAndForget(() => this.shutdown());
...
var Ko = class {
  ...
  Fi(t2, e, n, s) {
    return mn(e) || s.isEqual(st.min()) ? this.$i(t2, e) : this.Oi.getDocuments(t2, n).next((i) => {
      const r = this.Bi(e, i);
      return this.Li(e, r, n, s) ? this.$i(t2, e) : (S2() <= LogLevel.DEBUG && C2("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), vn(e)), this.qi(t2, r, e, mt(s, -1)));
    });
  }
  Bi(t2, e) {
    let n = new Ye(Sn(t2));
  ...
  $i(t2, e) {
    return S2() <= LogLevel.DEBUG && C2("QueryEngine", "Using full collection scan to execute query:", vn(e)), this.Oi.getDocumentsMatchingQuery(t2, e, yt.min());
  }
  qi(t2, e, n, s) {
...
var Go = class {
  constructor(t2, e, n, s) {
    this.persistence = t2, this.Ui = e, this.Tt = s, this.Ki = new We(X2), this.Gi = new ws((t3) => un(t3), cn), this.Qi = /* @__PURE__ */ new Map(), this.ji = t2.getRemoteDocumentCache(), this.Ns = t2.getTargetCache(), this.Os = t2.getBundleCache(), this.zi(n);
  }
  zi(t2) {
...
function eu(t2, e) {
  const n = $(t2), s = $(n.Ns), i = n.Ki.get(e);
...
function nu(t2, e) {
  const n = $(t2), s = n.Qi.get(e) || st.min();
...
async function ru(t2, e, n = vs()) {
  const s = await Zo(t2, Tn(cr(e.bundledQuery))), i = $(t2);
  return i.persistence.runTransaction("Save named query", "readwrite", (t3) => {
    const r = Qs(e.readTime);
    if (s.snapshotVersion.compareTo(r) >= 0)
      return i.Os.saveNamedQuery(t3, e);
    const o = s.withResumeToken(Ht.EMPTY_BYTE_STRING, r);
    return i.Ki = i.Ki.insert(o.targetId, o), i.Ns.updateTargetData(t3, o).next(() => i.Ns.removeMatchingKeysForTargetId(t3, s.targetId)).next(() => i.Ns.addMatchingKeys(t3, n, s.targetId)).next(() => i.Os.saveNamedQuery(t3, e));
  });
}
function ou(t2, e) {
...
var _u = class {
  ...
  addLocalQueryTarget(t2) {
    ...
    return this.br.sr(t2), this.pr(), e;
  }
  removeLocalQueryTarget(t2) {
    this.br.ir(t2), this.pr();
  }
        ...
        if (this.started) {
          if (null !== e.key) {
            if (this._r.test(e.key)) {
              ...
              if (null !== e.newValue) {
                const t3 = this.Or(e.key, e.newValue);
                if (t3)
                  return this.Mr(t3);
              }
              ...
              const t3 = this.Fr(e.newValue);
              await Promise.all(t3.map((t4) => this.syncEngine.$r(t4)));
            }
          }
        } else
          this.hr.push(e);
...
var Iu = class extends class {
  ...
  lo(t2, e, n, s, i) {
    ...
    const o = {};
    return this._o(o, s, i), this.wo(t2, r, o, n).then((t3) => (C2("RestConnection", "Received: ", t3), t3), (e2) => {
  ...
  yo(t2, e, n) {
    ...
    return f(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, C2("Connection", "WebChannel transport closed"), l2.oo());
    }), f(c, WebChannel.EventType.ERROR, (t3) => {
      h || (h = true, N2("Connection", "WebChannel transport errored:", t3), l2.oo(new L2(B2.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (i2) {
          ...
          void 0 === e3 && (e3 = B2.INTERNAL, n3 = "Unknown error status: " + t4 + " with message " + i2.message), h = true, l2.oo(new L2(e3, n3)), c.close();
        } else
          C2("Connection", "WebChannel received:", n2), l2.uo(n2);
      }
...
async function Su(t2, e, n) {
  const s = $(t2), i = function(t3, e2, n2) {
  ...
  constructor(t2, e, n, s, i) {
    this.localStore = t2, this.datastore = e, this.asyncQueue = n, this.remoteSyncer = {}, this._u = [], this.wu = /* @__PURE__ */ new Map(), this.mu = /* @__PURE__ */ new Set(), this.gu = [], this.yu = i, this.yu.Gr((t3) => {
      n.enqueueAndForget(async () => {
        Lu(this) && (C2("RemoteStore", "Restarting streams for network reachability change."), await async function(t4) {
          const e2 = $(t4);
...
function ku(t2, e) {
  const n = $(t2);
  n.wu.has(e.targetId) || (n.wu.set(e.targetId, e), Bu(n) ? $u(n) : ic2(n).Mo() && Mu(n, e));
}
function Ou(t2, e) {
  const n = $(t2), s = ic2(n);
...
function Mu(t2, e) {
  t2.Iu.Ft(e.targetId), ic2(t2).Jo(e);
}
function Fu(t2, e) {
  t2.Iu.Ft(e), ic2(t2).Yo(e);
}
function $u(t2) {
  t2.Iu = new Os({
    getRemoteKeysForTarget: (e) => t2.remoteSyncer.getRemoteKeysForTarget(e),
    ie: (e) => t2.wu.get(e) || null
  }), ic2(t2).start(), t2.pu.au();
}
function Bu(t2) {
  return Lu(t2) && !ic2(t2).Oo() && t2.wu.size > 0;
}
function Lu(t2) {
  return 0 === $(t2).mu.size;
}
...
async function Qu(t2, e, n) {
  ...
  t2.mu.add(1), await Nu(t2), t2.pu.set("Offline"), n || (n = () => Wo(t2.localStore)), t2.asyncQueue.enqueueRetryable(async () => {
    C2("RemoteStore", "Retrying IndexedDB access"), await n(), t2.mu.delete(1), await xu(t2);
  });
}
function ju(t2, e) {
...
function Ju(t2) {
  return Lu(t2) && !rc2(t2).Oo() && t2._u.length > 0;
}
function Yu(t2) {
  rc2(t2).start();
}
...
async function ec2(t2, e) {
  e && rc2(t2).Xo && await async function(t3, e2) {
    if (n = e2.code, ds(n) && n !== B2.ABORTED) {
      const n2 = t3._u.shift();
      rc2(t3).$o(), await ju(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), await zu(t3);
    }
    var n;
  }(t2, e), Ju(t2) && Yu(t2);
}
...
function rc2(t2) {
  return t2.Eu || (t2.Eu = function(t3, e, n) {
    ...
    e ? (t2.Eu.$o(), await zu(t2)) : (await t2.Eu.stop(), t2._u.length > 0 && (C2("RemoteStore", `Stopping write stream with ${t2._u.length} pending writes`), t2._u = []));
  })), t2.Eu;
}
var oc2 = class {
  constructor(t2, e, n, s, i) {
  ...
  static createAndSchedule(t2, e, n, s, i) {
    const r = Date.now() + n, o = new oc2(t2, e, r, s, i);
    return o.start(n), o;
  }
  start(t2) {
...
var ac2 = class {
  ...
  track(t2) {
    ...
    n ? 0 !== t2.type && 3 === n.type ? this.Au = this.Au.insert(e, t2) : 3 === t2.type && 1 !== n.type ? this.Au = this.Au.insert(e, {
      ...
      type: 2,
      doc: t2.doc
    }) : O2() : this.Au = this.Au.insert(e, t2);
  }
  Ru() {
    const t2 = [];
...
async function dc2(t2, e) {
  ...
  if (r || (i = true, r = new lc2()), i)
    try {
      r.bu = await n.onListen(s);
    } catch (t3) {
      const n2 = uc2(t3, `Initialization of query '${vn(e.query)}' failed`);
...
var yc2 = class {
  ...
  ku(t2) {
    t2 = hc2.fromInitialDocuments(t2.query, t2.docs, t2.mutatedKeys, t2.fromCache, t2.hasCachedResults), this.Du = true, this.Su.next(t2);
  }
};
var pc2 = class {
  constructor(t2, e) {
...
var Tc2 = class {
  constructor(t2, e, n) {
    this.$u = t2, this.localStore = e, this.Tt = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = Ec2(t2);
  }
  Bu(t2) {
  ...
  Lu(t2) {
    const e = /* @__PURE__ */ new Map(), n = new Ic2(this.Tt);
    for (const s of t2)
  ...
  async complete() {
    const t2 = await iu(this.localStore, new Ic2(this.Tt), this.documents, this.$u.id), e = this.Lu(this.documents);
...
var bc2 = class {
  constructor(t2, e) {
    this.query = t2, this.Ku = e, this.Gu = null, this.hasCachedResults = false, this.current = false, this.Qu = vs(), this.mutatedKeys = vs(), this.ju = Sn(t2), this.zu = new cc2(this.ju);
  }
  get Wu() {
    return this.Ku;
  }
  Hu(t2, e) {
    const n = e ? e.Ju : new ac2(), s = e ? e.zu : this.zu;
  ...
  Xu() {
    ...
    const e = [];
    return t2.forEach((t3) => {
      this.Qu.has(t3) || e.push(new Rc2(t3));
    }), this.Qu.forEach((n) => {
      t2.has(n) || e.push(new Ac2(n));
    }), e;
  }
  nc(t2) {
  ...
  sc() {
    return hc2.fromInitialDocuments(this.query, this.zu, this.mutatedKeys, 0 === this.Gu, this.hasCachedResults);
  }
};
var vc2 = class {
  constructor(t2, e, n) {
...
async function Sc2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await Dc2(n, e, s, "current" === r2, t3.resumeToken);
  }
  return i;
}
async function Dc2(t2, e, n, s, i) {
  t2.mc = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    return Kc2(t3, e3.targetId, o2.tc), o2.snapshot;
  }(t2, e2, n2, s2);
  const r = await tu(
    t2.localStore,
    e,
    true
  ), o = new bc2(e, r.Yi), u = o.Hu(r.documents), c = Ds.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState, i), a = o.applyChanges(
    u,
    t2.isPrimaryClient,
    c
  );
  Kc2(t2, n, a.tc);
  const h = new vc2(e, n, o);
...
async function Cc2(t2, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await Xo(
      ...
      n.sharedClientState.clearQueryState(s.targetId), Ou(n.remoteStore, s.targetId), qc2(n, s.targetId);
    }).catch(Et);
  } else
    qc2(n, s.targetId), await Xo(
      n.localStore,
      s.targetId,
      true
    );
...
async function xc2(t2, e, n) {
  ...
  try {
    ...
    }(s, t3.batchId, n), await jc2(s, t3.changes), await zu(s.remoteStore);
  } catch (t3) {
    const e2 = uc2(t3, "Failed to persist write");
    n.reject(e2);
  }
}
async function Nc2(t2, e) {
...
async function Oc2(t2, e, n) {
  ...
  if (r) {
    ...
    await Nc2(s, i2), s.ac = s.ac.remove(r), s.hc.delete(e), Qc2(s);
  } else
    await Xo(
      s.localStore,
      e,
      false
    ).then(() => qc2(s, e, n)).catch(Et);
}
async function Mc2(t2, e) {
  const n = $(t2), s = e.batch.batchId;
  try {
    const t3 = await zo(n.localStore, e);
    Lc2(n, s, null), Bc2(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await jc2(n, t3);
  } catch (t3) {
    await Et(t3);
  }
}
async function Fc2(t2, e, n) {
  ...
  try {
    ...
    Lc2(s, e, n), Bc2(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), await jc2(s, t3);
  } catch (n2) {
    await Et(n2);
  }
}
async function $c2(t2, e) {
  const n = $(t2);
  Lu(n.remoteStore) || C2("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
  try {
    ...
    const n2 = uc2(t3, "Initialization of waitForPendingWrites() operation failed");
    e.reject(n2);
  }
}
function Bc2(t2, e) {
...
function qc2(t2, e, n = null) {
  ...
  if (t2.uc.delete(e), t2.isPrimaryClient) {
    t2.lc.ds(e).forEach((e2) => {
      t2.lc.containsKey(e2) || Uc2(t2, e2);
    });
  }
}
function Uc2(t2, e) {
  ...
  const n = t2.ac.get(e);
  null !== n && (Ou(t2.remoteStore, n), t2.ac = t2.ac.remove(e), t2.hc.delete(n), Qc2(t2));
}
function Kc2(t2, e, n) {
  for (const s of n)
    if (s instanceof Ac2)
      t2.lc.addReference(s.key, e), Gc2(t2, s);
    else if (s instanceof Rc2) {
      C2("SyncEngine", "Document no longer in limbo: " + s.key), t2.lc.removeReference(s.key, e);
      t2.lc.containsKey(s.key) || Uc2(t2, s.key);
    } else
      O2();
}
function Gc2(t2, e) {
  const n = e.key, s = n.path.canonicalString();
  t2.ac.get(n) || t2.cc.has(s) || (C2("SyncEngine", "New document in limbo: " + n), t2.cc.add(s), Qc2(t2));
}
function Qc2(t2) {
  for (; t2.cc.size > 0 && t2.ac.size < t2.maxConcurrentLimboResolutions; ) {
    ...
    t2.hc.set(s, new Pc2(n)), t2.ac = t2.ac.insert(n, s), ku(t2.remoteStore, new Zi(Tn(wn(n.path)), s, 2, Ot.at));
  }
}
async function jc2(t2, e, n) {
  const s = $(t2), i = [], r = [], o = [];
...
async function zc2(t2, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(e, t3.removedBatchIds, t3.addedBatchIds), await jc2(n, t3.Wi);
  }
}
function Wc2(t2, e) {
...
async function Hc2(t2, e) {
  const n = $(t2), s = await tu(
    n.localStore,
    e.query,
    true
  ), i = e.view.nc(s);
  return n.isPrimaryClient && Kc2(n, e.targetId, i.tc), i;
}
async function Jc2(t2, e) {
  const n = $(t2);
  return nu(n.localStore, e).then((t3) => jc2(n, t3));
}
async function Yc2(t2, e, n, s) {
  ...
  null !== r ? ("pending" === n ? await zu(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (Lc2(i, e, s || null), Bc2(i, e), function(t3, e2) {
    $($(t3).mutationQueue).bn(e2);
  }(i.localStore, e)) : O2(), await jc2(i, r)) : C2("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
async function Zc2(t2, e) {
  const n = $(t2);
  if (ia2(n), ra2(n), true === e && true !== n.wc) {
    const t3 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await Xc2(n, t3.toArray());
    n.wc = true, await sc2(n.remoteStore, true);
    for (const t4 of e2)
      ku(n.remoteStore, t4);
    ...
    n.uc.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (qc2(n, i), Xo(
        n.localStore,
        i,
        true
      ))), Ou(n.remoteStore, i);
    }), await e2, await Xc2(n, t3), function(t4) {
      const e3 = $(t4);
      e3.hc.forEach((t5, n2) => {
        Ou(e3.remoteStore, n2);
      }), e3.lc._s(), e3.hc = /* @__PURE__ */ new Map(), e3.ac = new We(ct.comparator);
    }(n), n.wc = false, await sc2(n.remoteStore, false);
  }
}
async function Xc2(t2, e, n) {
  const s = $(t2), i = [], r = [];
  for (const t3 of e) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const t4 of n2) {
        const e3 = s.oc.get(t4), n3 = await Hc2(s, e3);
        n3.snapshot && r.push(n3.snapshot);
      }
    } else {
      const n3 = await eu(s.localStore, t3);
      e2 = await Zo(s.localStore, n3), await Dc2(
        s,
        ta2(n3),
        t3,
        false,
  ...
  if (s.wc) {
    ...
    for (const t3 of n)
      s.uc.has(t3) && await Xo(
        ...
        Ou(s.remoteStore, t3), qc2(s, t3);
      }).catch(Et);
  }
}
function ia2(t2) {
  const e = $(t2);
  return e.remoteStore.remoteSyncer.applyRemoteEvent = Nc2.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Wc2.bind(null, e), e.remoteStore.remoteSyncer.rejectListen = Oc2.bind(null, e), e.rc.Ho = wc2.bind(null, e.eventManager), e.rc.gc = mc2.bind(null, e.eventManager), e;
}
function ra2(t2) {
  const e = $(t2);
  return e.remoteStore.remoteSyncer.applySuccessfulWrite = Mc2.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Fc2.bind(null, e), e;
}
function oa2(t2, e, n) {
  const s = $(t2);
  (async function(t3, e2, n2) {
    try {
      ...
      if (await function(t4, e3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", (t5) => n3.Os.getBundleMetadata(t5, e3.id)).then((t5) => !!t5 && t5.createTime.compareTo(s3) >= 0);
      }(t3.localStore, s2))
      ...
      n2._updateProgress(Ec2(s2));
      const i = new Tc2(s2, t3.localStore, e2.Tt);
      let r = await e2.yc();
      for (; r; ) {
      ...
      return await jc2(
        ...
        const n3 = $(t4);
        return n3.persistence.runTransaction("Save bundle", "readwrite", (t5) => n3.Os.saveBundleMetadata(t5, e3));
...
var ca2 = class extends ua2 {
  constructor(t2, e, n) {
    super(), this.bc = t2, this.cacheSizeBytes = e, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(t2) {
    await super.initialize(t2), await this.bc.initialize(this, t2), await ra2(this.bc.syncEngine), await zu(this.bc.remoteStore), await this.persistence.di(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  Ec(t2) {
    return Qo(this.persistence, new Ko(), t2.initialUser, this.Tt);
  }
  ...
  Tc(t2) {
    ...
    return new $o(this.synchronizeTabs, e, t2.clientId, n, t2.asyncQueue, Tu(), Eu(), this.Tt, this.sharedClientState, !!this.forceOwnership);
  }
  Ic(t2) {
    return new wu();
  }
};
var aa2 = class extends ca2 {
  constructor(t2, e) {
    super(t2, e, false), this.bc = t2, this.cacheSizeBytes = e, this.synchronizeTabs = true;
  }
  async initialize(t2) {
    ...
    this.sharedClientState instanceof _u && (this.sharedClientState.syncEngine = {
      ...
      await Zc2(this.bc.syncEngine, t3), this.gcScheduler && (t3 && !this.gcScheduler.started ? this.gcScheduler.start() : t3 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (t3 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : t3 || this.indexBackfillerScheduler.stop());
    });
  }
  Ic(t2) {
    const e = Tu();
...
var ha2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(
      e,
      !t2.synchronizeTabs
    ), this.sharedClientState.onlineStateHandler = (t3) => kc2(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = zc2.bind(null, this.syncEngine), await sc2(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  createRemoteStore(t2) {
    return e = this.localStore, n = this.datastore, s = t2.asyncQueue, i = (t3) => kc2(this.syncEngine, t3, 0), r = gu.C() ? new gu() : new mu(), new Cu(e, n, s, i, r);
    var e, n, s, i, r;
  }
  createSyncEngine(t2, e) {
    return function(t3, e2, n, s, i, r, o) {
      const u = new Vc2(t3, e2, n, s, i, r);
  ...
  terminate() {
    return async function(t2) {
      const e = $(t2);
      C2("RemoteStore", "RemoteStore shutting down."), e.mu.add(5), await Nu(e), e.yu.shutdown(), e.pu.set("Unknown");
    }(this.remoteStore);
  }
};
function la2(t2, e = 10240) {
  let n = 0;
  return {
    async read() {
      if (n < t2.byteLength) {
...
var da2 = class {
  constructor(t2, e) {
    this.Vc = t2, this.Tt = e, this.metadata = new q2(), this.buffer = new Uint8Array(), this.Sc = new TextDecoder("utf-8"), this.Dc().then((t3) => {
      t3 && t3.Fu() ? this.metadata.resolve(t3.Mu.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
...
var _a = class {
  ...
  async lookup(t2) {
    ...
    const e = await async function(t3, e2) {
      const n = $(t3), s = Zs(n.Tt) + "/documents", i = {
...
var wa2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.Mc = n.maxAttempts, this.ko = new Ru(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Mc -= 1, this.Fc();
  }
  Fc() {
    this.ko.vo(async () => {
      const t2 = new _a(this.datastore), e = this.$c(t2);
      e && e.then((e2) => {
  ...
  Bc(t2) {
    this.Mc > 0 && this.Lc(t2) ? (this.Mc -= 1, this.asyncQueue.enqueueAndForget(() => (this.Fc(), Promise.resolve()))) : this.deferred.reject(t2);
  }
  Lc(t2) {
  ...
  terminate() {
    ...
    return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
      try {
        ...
        const n = uc2(e, "Failed to shutdown persistence");
        t2.reject(n);
      }
    }), t2.promise;
  }
...
async function ya2(t2, e) {
  ...
  const n = await pa2(t2);
  C2("FirestoreClient", "Initializing OnlineComponentProvider");
  const s = await t2.getConfiguration();
  await e.initialize(n, s), t2.setCredentialChangeListener((t3) => nc2(e.remoteStore, t3)), t2.setAppCheckTokenChangeListener((t3, n2) => nc2(e.remoteStore, n2)), t2.onlineComponents = e;
}
async function pa2(t2) {
  return t2.offlineComponents || (C2("FirestoreClient", "Using default OfflineComponentProvider"), await ga(t2, new ua2())), t2.offlineComponents;
}
async function Ia2(t2) {
  return t2.onlineComponents || (C2("FirestoreClient", "Using default OnlineComponentProvider"), await ya2(t2, new ha2())), t2.onlineComponents;
}
function Ta2(t2) {
  return pa2(t2).then((t3) => t3.persistence);
}
function Ea2(t2) {
  return pa2(t2).then((t3) => t3.localStore);
}
function Aa2(t2) {
  return Ia2(t2).then((t3) => t3.remoteStore);
}
function Ra2(t2) {
  return Ia2(t2).then((t3) => t3.syncEngine);
}
function ba2(t2) {
  return Ia2(t2).then((t3) => t3.datastore);
}
async function va2(t2) {
  const e = await Ia2(t2), n = e.eventManager;
  return n.onListen = Sc2.bind(null, e.syncEngine), n.onUnlisten = Cc2.bind(null, e.syncEngine), n;
}
function Pa2(t2) {
  return t2.asyncQueue.enqueue(async () => {
    const e = await Ta2(t2), n = await Aa2(t2);
    return e.setNetworkEnabled(true), function(t3) {
      const e2 = $(t3);
      return e2.mu.delete(0), xu(e2);
    }(n);
  });
}
function Va2(t2) {
  return t2.asyncQueue.enqueue(async () => {
    ...
    return e.setNetworkEnabled(false), async function(t3) {
      const e2 = $(t3);
      e2.mu.add(0), await Nu(e2), e2.pu.set("Offline");
    }(n);
  });
}
function Sa2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      ...
      const s = uc2(t4, `Failed to get document '${e2} from cache`);
      n2.reject(s);
    }
  }(await Ea2(t2), e, n)), n.promise;
}
function Da(t2, e, n = {}) {
  const s = new q2();
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    ...
    }), o = new yc2(wn(n2.path), r, {
      includeMetadataChanges: true,
      Ou: true
    });
    return dc2(t3, o);
  }(await va2(t2), t2.asyncQueue, e, n, s)), s.promise;
}
function Ca(t2, e) {
  const n = new q2();
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await tu(
        ...
        e2,
        true
      ), i = new bc2(e2, s.Yi), r = i.Hu(s.documents), o = i.applyChanges(
        r,
        false
      );
      n2.resolve(o.snapshot);
    } catch (t4) {
      const s = uc2(t4, `Failed to execute query '${e2} against cache`);
      n2.reject(s);
    }
  }(await Ea2(t2), e, n)), n.promise;
}
function xa2(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new fa2({
      next: (n3) => {
        e2.enqueueAndForget(() => _c(t3, o)), n3.fromCache && "server" === s2.source ? i.reject(new L2(B2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new yc2(n2, r, {
      includeMetadataChanges: true,
...
function Na2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2) {
    $(t3).vu.add(e2), e2.next();
  }(await va2(t2), n)), () => {
    n.Pc(), t2.asyncQueue.enqueueAndForget(async () => function(t3, e2) {
      $(t3).vu.delete(e2);
    }(await va2(t2), n));
  };
}
function ka(t2, e, n, s) {
  const i = function(t3, e2) {
    let n2;
    n2 = "string" == typeof t3 ? new TextEncoder().encode(t3) : t3;
    return function(t4, e3) {
      return new da2(t4, e3);
    }(function(t4, e3) {
      if (t4 instanceof Uint8Array)
        return la2(t4, e3);
      if (t4 instanceof ArrayBuffer)
        return la2(new Uint8Array(t4), e3);
  ...
  t2.asyncQueue.enqueueAndForget(async () => {
    oa2(await Ra2(t2), i, s);
  });
}
function Oa2(t2, e) {
  return t2.asyncQueue.enqueue(async () => function(t3, e2) {
    const n = $(t3);
    return n.persistence.runTransaction("Get named query", "readonly", (t4) => n.Os.getNamedQuery(t4, e2));
  }(await Ea2(t2), e));
}
...
var Qa2 = class {
  ...
  _terminate() {
    return function(t2) {
      const e = Ma2.get(t2);
      e && (C2("ComponentProvider", "Removing Datastore"), Ma2.delete(t2), e.terminate());
    }(this), Promise.resolve();
  }
};
function ja2(t2, e, n, s = {}) {
  var i;
  const r = (t2 = Ua2(t2, Qa2))._getSettings();
...
var za2 = class {
  ...
  withConverter(t2) {
    return new za2(this.firestore, t2, this._key);
  }
};
var Wa2 = class {
  constructor(t2, e, n) {
  ...
  withConverter(t2) {
    return new Wa2(this.firestore, t2, this._query);
  }
};
var Ha = class extends Wa2 {
  constructor(t2, e, n) {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new za2(
      this.firestore,
      null,
      new ct(t2)
    );
...
function Ja2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), Fa("collection", "path", e), t2 instanceof Qa2) {
    const s = rt.fromString(e, ...n);
    return La2(s), new Ha(t2, null, s);
  }
  {
    if (!(t2 instanceof za2 || t2 instanceof Ha))
...
function Ya2(t2, e) {
  if (t2 = Ua2(t2, Qa2), Fa("collectionGroup", "collection id", e), e.indexOf("/") >= 0)
...
function Za(t2, e, ...n) {
  if (t2 = getModularInstance(t2), 1 === arguments.length && (e = Z.R()), Fa("doc", "path", e), t2 instanceof Qa2) {
    const s = rt.fromString(e, ...n);
    return Ba2(s), new za2(
      t2,
      null,
      new ct(s)
    );
  }
  {
    if (!(t2 instanceof za2 || t2 instanceof Ha))
      throw new L2(B2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    const s = t2._path.child(rt.fromString(e, ...n));
    return Ba2(s), new za2(t2.firestore, t2 instanceof Ha ? t2.converter : null, new ct(s));
  }
}
function Xa2(t2, e) {
  return t2 = getModularInstance(t2), e = getModularInstance(e), (t2 instanceof za2 || t2 instanceof Ha) && (e instanceof za2 || e instanceof Ha) && (t2.firestore === e.firestore && t2.path === e.path && t2.converter === e.converter);
}
function th(t2, e) {
  return t2 = getModularInstance(t2), e = getModularInstance(e), t2 instanceof Wa2 && e instanceof Wa2 && (t2.firestore === e.firestore && Rn(t2._query, e._query) && t2.converter === e.converter);
}
var eh = class {
  constructor() {
  ...
  enqueueAfterDelay(t2, e, n) {
    ...
    const s = oc2.createAndSchedule(this, t2, e, n, (t3) => this.Xc(t3));
...
function hh(t2, e) {
  Ih(t2 = Ua2(t2, rh));
  const n = ch(t2), s = t2._freezeSettings(), i = new ha2();
  return fh(n, i, new ca2(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
function lh(t2) {
  Ih(t2 = Ua2(t2, rh));
  const e = ch(t2), n = t2._freezeSettings(), s = new ha2();
  return fh(e, s, new aa2(s, n.cacheSizeBytes));
}
function fh(t2, e, n) {
  const s = new q2();
  return t2.asyncQueue.enqueue(async () => {
    try {
      await ga(t2, n), await ya2(t2, e), s.resolve();
    } catch (t3) {
      const e2 = t3;
      if (!function(t4) {
...
function _h(t2) {
  return function(t3) {
    const e = new q2();
    return t3.asyncQueue.enqueueAndForget(async () => $c2(await Ra2(t3), e)), e.promise;
  }(ch(t2 = Ua2(t2, rh)));
}
function wh(t2) {
  return Pa2(ch(t2 = Ua2(t2, rh)));
}
function mh(t2) {
  return Va2(ch(t2 = Ua2(t2, rh)));
}
function gh(t2) {
  return _removeServiceInstance(t2.app, "firestore", t2._databaseId.database), t2._delete();
}
function yh(t2, e) {
  const n = ch(t2 = Ua2(t2, rh)), s = new sh();
  return ka(n, t2._databaseId, e, s), s;
}
function ph(t2, e) {
  return Oa2(ch(t2 = Ua2(t2, rh)), e).then((e2) => e2 ? new Wa2(t2, null, e2.query) : null);
}
function Ih(t2) {
  if (t2._initialized || t2._terminated)
...
function Qh(t2, e) {
  ...
  return function(t3, e2) {
    ...
    throw e2.fa(`Unsupported field value: ${qa2(t3)}`);
  }(t2, e);
}
function jh(t2, e) {
  const n = {};
...
function zh(t2) {
  return !("object" != typeof t2 || null === t2 || t2 instanceof Array || t2 instanceof Date || t2 instanceof nt || t2 instanceof Ph || t2 instanceof Ah || t2 instanceof za2 || t2 instanceof vh);
}
function Wh(t2, e, n) {
  if (!zh(n) || !function(t3) {
...
var tl = class {
  ...
  get ref() {
    return new za2(this._firestore, this._converter, this._key);
  }
  exists() {
...
var ul = class extends rl {
  ...
  _apply(t2) {
    ...
    return vl(t2._query, e), new Wa2(t2.firestore, t2.converter, En(t2._query, e));
  }
  _parse(t2) {
...
function cl(t2, e, n) {
  const s = e, i = nl("where", t2);
  return ul._create(i, s, n);
}
var al = class extends il {
  constructor(t2, e) {
  ...
  _apply(t2) {
    ...
    return 0 === e.getFilters().length ? t2 : (function(t3, e2) {
      ...
      for (const t4 of s)
        vl(n, t4), n = En(n, t4);
    }(t2._query, e), new Wa2(t2.firestore, t2.converter, En(t2._query, e)));
  }
...
function hl(...t2) {
  return t2.forEach((t3) => Vl("or", t3)), al._create("or", t2);
}
function ll(...t2) {
  return t2.forEach((t3) => Vl("and", t3)), al._create("and", t2);
}
var fl = class extends rl {
  constructor(t2, e) {
  ...
  _apply(t2) {
    ...
    return new Wa2(t2.firestore, t2.converter, function(t3, e2) {
...
var _l = class extends rl {
  ...
  _apply(t2) {
    return new Wa2(t2.firestore, t2.converter, An(t2._query, this._limit, this._limitType));
  }
};
function wl(t2) {
  return Ka("limit", t2), _l._create("limit", t2, "F");
}
function ml(t2) {
  return Ka("limitToLast", t2), _l._create("limitToLast", t2, "L");
}
var gl = class extends rl {
  constructor(t2, e, n) {
  ...
  _apply(t2) {
    const e = Al(t2, this.type, this._docOrFields, this._inclusive);
    return new Wa2(t2.firestore, t2.converter, function(t3, e2) {
...
function Al(t2, e, n, s) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof tl)
...
function Rl(t2, e, n) {
  ...
  if (n instanceof za2)
    return fe(t2, n._key);
  throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${qa2(n)}.`);
}
function bl(t2, e) {
...
function Vl(t2, e) {
  if (!(e instanceof ul || e instanceof al))
...
var Cl = class extends Sl {
  ...
  convertReference(t2) {
    ...
    return new za2(this.firestore, null, e);
  }
};
function xl(t2) {
  return new Th("sum", Hh("sum", t2));
}
function Nl(t2) {
  return new Th("avg", Hh("average", t2));
}
function kl() {
  return new Th("count");
}
function Ol(t2, e) {
  var n, s;
  return t2 instanceof Th && e instanceof Th && t2._aggregateType === e._aggregateType && (null === (n = t2._internalFieldPath) || void 0 === n ? void 0 : n.canonicalString()) === (null === (s = e._internalFieldPath) || void 0 === s ? void 0 : s.canonicalString());
}
function Ml(t2, e) {
  return th(t2.query, e.query) && deepEqual(t2.data(), e.data());
}
var Fl = class {
  constructor(t2, e) {
...
function Ul(t2, e) {
  return t2 instanceof $l && e instanceof $l ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (null === t2._document ? null === e._document : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof Ll && e instanceof Ll && (t2._firestore === e._firestore && th(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot));
}
function Kl(t2) {
  t2 = Ua2(t2, za2);
  const e = Ua2(t2.firestore, rh);
...
function Ql(t2) {
  t2 = Ua2(t2, za2);
  const e = Ua2(t2.firestore, rh), n = ch(e), s = new Gl(e);
  return Sa2(n, t2._key).then((n2) => new $l(e, s, t2._key, n2, new Fl(
...
function zl(t2) {
  t2 = Ua2(t2, Wa2);
  const e = Ua2(t2.firestore, rh), n = ch(e), s = new Gl(e);
  return sl(t2._query), xa2(n, t2._query).then((n2) => new Ll(e, s, t2, n2));
}
function Wl(t2) {
  t2 = Ua2(t2, Wa2);
  const e = Ua2(t2.firestore, rh), n = ch(e), s = new Gl(e);
  return Ca(n, t2._query).then((n2) => new Ll(e, s, t2, n2));
}
function Hl(t2) {
  t2 = Ua2(t2, Wa2);
  const e = Ua2(t2.firestore, rh), n = ch(e), s = new Gl(e);
  return xa2(n, t2._query, {
    source: "server"
  }).then((n2) => new Ll(e, s, t2, n2));
}
function Jl(t2, e, n) {
  t2 = Ua2(t2, za2);
  const s = Ua2(t2.firestore, rh), i = Dl(t2.converter, e, n);
  return nf(s, [Oh(kh(s), "setDoc", t2._key, i, null !== t2.converter, n).toMutation(t2._key, Hn.none())]);
}
function Yl(t2, e, n, ...s) {
  t2 = Ua2(t2, za2);
  const i = Ua2(t2.firestore, rh), r = kh(i);
  let o;
...
function Zl(t2) {
  return nf(Ua2(t2.firestore, rh), [new cs(t2._key, Hn.none())]);
}
function Xl(t2, e) {
  const n = Ua2(t2.firestore, rh), s = Za(t2), i = Dl(t2.converter, e);
...
function tf(t2, ...e) {
  ...
  if (t2 instanceof za2)
    a = Ua2(t2.firestore, rh), h = wn(t2._key.path), c = {
      next: (n2) => {
        e[o] && e[o](sf(a, t2, n2));
      },
      error: e[o + 1],
    ...
    const n2 = Ua2(t2, Wa2);
    a = Ua2(n2.firestore, rh), h = n2._query;
    const s2 = new Gl(a);
    c = {
      next: (t3) => {
  ...
  return function(t3, e2, n2, s2) {
    const i2 = new fa2(s2), r2 = new yc2(e2, i2, n2);
    return t3.asyncQueue.enqueueAndForget(async () => dc2(await va2(t3), r2)), () => {
      i2.Pc(), t3.asyncQueue.enqueueAndForget(async () => _c(await va2(t3), r2));
    };
  }(ch(a), h, u, c);
}
function ef(t2, e) {
  return Na2(ch(t2 = Ua2(t2, rh)), nh(e) ? e : {
    next: e
  });
}
function nf(t2, e) {
  return function(t3, e2) {
    const n = new q2();
    return t3.asyncQueue.enqueueAndForget(async () => xc2(await Ra2(t3), e2, n)), n.promise;
  }(ch(t2), e);
}
function sf(t2, e, n) {
...
function of(t2, e) {
  const n = Ua2(t2.firestore, rh), s = ch(n), i = function(t3, e2) {
    const n2 = [];
    for (const s2 in t3)
      Object.prototype.hasOwnProperty.call(t3, s2) && n2.push(e2(t3[s2], s2, t3));
    return n2;
  }(e, (t3, e2) => new $t(new Ft(e2), t3._aggregateType, t3._internalFieldPath));
  return function(t3, e2, n2) {
    const s2 = new q2();
    return t3.asyncQueue.enqueueAndForget(async () => {
      try {
        if (Lu(await Aa2(t3))) {
          const i2 = await ba2(t3);
          s2.resolve(Su(i2, e2, n2));
        } else
...
var cf = class {
  constructor(t2, e) {
    this._firestore = t2, this._commitHandler = e, this._mutations = [], this._committed = false, this._dataReader = kh(t2);
  }
  set(t2, e, n) {
    this._verifyNotCommitted();
    const s = af(t2, this._firestore), i = Dl(s.converter, e, n), r = Oh(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
    return this._mutations.push(r.toMutation(s._key, Hn.none())), this;
  }
  update(t2, e, n, ...s) {
    this._verifyNotCommitted();
    const i = af(t2, this._firestore);
    let r;
    return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Rh ? Kh(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Uh(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, Hn.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
    const e = af(t2, this._firestore);
...
var hf = class extends class {
  constructor(t2, e) {
    this._firestore = t2, this._transaction = e, this._dataReader = kh(t2);
  }
  get(t2) {
    const e = af(t2, this._firestore), n = new Cl(this._firestore);
    return this._transaction.lookup([e._key]).then((t3) => {
      if (!t3 || 1 !== t3.length)
        return O2();
      const s = t3[0];
      if (s.isFoundDocument())
        return new tl(this._firestore, n, s.key, s, e.converter);
      if (s.isNoDocument())
        return new tl(this._firestore, n, e._key, null, e.converter);
      throw O2();
    });
  }
  set(t2, e, n) {
    const s = af(t2, this._firestore), i = Dl(s.converter, e, n), r = Oh(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = af(t2, this._firestore);
    let r;
    return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Rh ? Kh(this._dataReader, "Transaction.update", i._key, e, n, s) : Uh(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = af(t2, this._firestore);
  ...
  get(t2) {
    const e = af(t2, this._firestore), n = new Gl(this._firestore);
    return super.get(t2).then((t3) => new $l(this._firestore, n, e._key, t3._document, new Fl(
      false,
      false
    ), e.converter));
  }
...
function lf(t2, e, n) {
  ...
  return function(t3, e2, n2) {
    const s2 = new q2();
    return t3.asyncQueue.enqueueAndForget(async () => {
      const i = await ba2(t3);
      new wa2(t3.asyncQueue, i, n2, e2, s2).run();
    }), s2.promise;
  }(ch(t2), (n2) => e(new hf(t2, n2)), s);
}
function ff() {
...
function mf(t2) {
  return new qh("increment", t2);
}
function gf(t2) {
  return ch(t2 = Ua2(t2, rh)), new cf(t2, (e) => nf(t2, e));
}
function yf(t2, e) {
  var n;
  const s = ch(t2 = Ua2(t2, rh));
  ...
  const i = function(t3) {
    ...
    if (Array.isArray(e2.indexes))
      for (const t4 of e2.indexes) {
        const e3 = pf(t4, "collectionGroup"), s2 = [];
        if (Array.isArray(t4.fields))
          for (const e4 of t4.fields) {
            const t5 = Yh("setIndexConfiguration", pf(e4, "fieldPath"));
  ...
  return Ea2(s).then((t3) => async function(t4, e2) {
...
!function(t2, e = true) {
  !function(t3) {
    ...
    const i = t3.getProvider("app").getImmediate(), r = new rh(new Q2(t3.getProvider("auth-internal")), new H2(t3.getProvider("app-check-internal")), function(t4, e2) {
...
export {
  Sl as AbstractUserDataWriter,
  Th as AggregateField,
  Eh as AggregateQuerySnapshot,
  Ah as Bytes,
  ih as CACHE_SIZE_UNLIMITED,
  Ha as CollectionReference,
  za2 as DocumentReference,
  $l as DocumentSnapshot,
  Rh as FieldPath,
  vh as FieldValue,
  rh as Firestore,
  L2 as FirestoreError,
  Ph as GeoPoint,
  sh as LoadBundleTask,
  Wa2 as Query,
  al as QueryCompositeFilterConstraint,
  rl as QueryConstraint,
  Bl as QueryDocumentSnapshot,
  Il as QueryEndAtConstraint,
  ul as QueryFieldFilterConstraint,
  _l as QueryLimitConstraint,
  fl as QueryOrderByConstraint,
  Ll as QuerySnapshot,
  gl as QueryStartAtConstraint,
  Fl as SnapshotMetadata,
  nt as Timestamp,
  hf as Transaction,
  cf as WriteBatch,
  Lt as _DatabaseId,
  ...
  N2 as _logWarn,
  $a2 as _validateIsNotUsedTogether,
  Xl as addDoc,
  Ol as aggregateFieldEqual,
  Ml as aggregateQuerySnapshotEqual,
  ll as and,
  wf as arrayRemove,
  _f as arrayUnion,
  Nl as average,
  dh as clearIndexedDbPersistence,
  Ja2 as collection,
  Ya2 as collectionGroup,
  ja2 as connectFirestoreEmulator,
  kl as count,
  Zl as deleteDoc,
  ff as deleteField,
  ...
  Za as doc,
  bh as documentId,
  hh as enableIndexedDbPersistence,
  lh as enableMultiTabIndexedDbPersistence,
  wh as enableNetwork,
  El as endAt,
  Tl as endBefore,
  ch as ensureFirestoreConfigured,
  nf as executeWrite,
  of as getAggregateFromServer,
  rf as getCountFromServer,
  Kl as getDoc,
  Ql as getDocFromCache,
  jl as getDocFromServer,
  zl as getDocs,
  Wl as getDocsFromCache,
  Hl as getDocsFromServer,
  uh as getFirestore,
  mf as increment,
  oh as initializeFirestore,
  wl as limit,
  ml as limitToLast,
  yh as loadBundle,
  ph as namedQuery,
  tf as onSnapshot,
  ef as onSnapshotsInSync,
  hl as or,
  dl as orderBy,
  ol as query,
  th as queryEqual,
  Xa2 as refEqual,
  lf as runTransaction,
  df as serverTimestamp,
  Jl as setDoc,
  yf as setIndexConfiguration,
  D2 as setLogLevel,
  Ul as snapshotEqual,
  pl as startAfter,
  yl as startAt,
